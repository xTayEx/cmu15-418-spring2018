...
__device__ __inline__ void shadePixel(int circleIndex, float2 pixelCenter,
  ...
  // We suggest that you think about ensuring order in your parallel solution first, and only then consider the atomicity problem (if it still exists at all) in your solution.
